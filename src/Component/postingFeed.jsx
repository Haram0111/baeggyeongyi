                ...
                feed && feed.map((a,i)=>{
                    return(
                        <>                            
                            ...
                            <div>{a.text}</div>
                            <div>{a.text}</div>
                            <FontAwesomeIcon icon={faThumbsUp} style={{fontSize: "10px", color: "white"}}></FontAwesomeIcon>좋아요
                            <FontAwesomeIcon icon={faComments} style={{fontSize: "10px", color: "white"}}></FontAwesomeIcon>댓글달기
                            <FontAwesomeIcon icon={faPaperPlane} style={{fontSize: "10px", color: "white"}}></FontAwesomeIcon>공유
                        </>
                    )
                })
            }
